...
public class VenuesController : ControllerBase
{
    ...
    private static readonly Dictionary<string, (string City, string Venue, DateTime EventDate)> VenueMapping = new()
    {
        ...
        { "Night 06", ("Nottingham", "Motorpoint Arena Nottingham", new DateTime(2025, 3, 13)) },
        { "Night 07", ("Cardiff", "Motorpoint Arena Cardiff", new DateTime(2025, 3, 20)) },
        { "Night 08", ("Newcastle", "Utilita Arena Newcastle", new DateTime(2025, 3, 27)) },
        { "Night 09", ("Berlin", "Uber Arena", new DateTime(2025, 4, 3)) },
